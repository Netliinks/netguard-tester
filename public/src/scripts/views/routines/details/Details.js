...
import { CloseDialog, renderRightSidebar, drawTagsIntoTables, filterDataByHeaderType, inputObserver, pageNumbers, fillBtnPagination, calculateLine, searchUniversalSingle, getPermission } from "../../../tools.js";
...
const GetRoutinesDetails = async () => {
    ...
    if(Config.currentUser?.isMaster){
        ...
        const permission = await getPermission('ROUTINE_DETAIL', Config.currentUser.id);
