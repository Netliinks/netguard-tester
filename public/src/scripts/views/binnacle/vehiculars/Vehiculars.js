...
import { CloseDialog, drawTagsIntoTables, renderRightSidebar, filterDataByHeaderType, inputObserver, pageNumbers, fillBtnPagination, getPermission } from "../../../tools.js";
...
const GetVehiculars = async () => {
    ...
    if(Config.currentUser?.isMaster){
        ...
        const permission = await getPermission('VEHICULAR', Config.currentUser.id);
